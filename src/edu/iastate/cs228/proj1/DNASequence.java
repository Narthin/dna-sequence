...
public class DNASequence extends Sequence
{
  ...
  */
  ...
  {
    super(dnaarr);//invoke super constructor
  }//end constructor
  ...
  */
  @Override
  public boolean isValidLetter(char let)//new valid letter procedure
  {
	String valid = "AaCcGgTt";//valid letters
	return valid.contains(""+let);//search valid letters for let
