...
public class ProteinSequence extends Sequence
{
  ...
  */  
  ...
  {
    super(psarr);//invoke super constructor
  }//end constructor
  ...
  */
  ...
  {
    String valid = "AaCcDdEeFfGgHhIiKkLlMmNnPpQqRrSsTtVvWwYy";//list of valid letters
    return valid.contains(""+aa);//search valid for aa
  }//end isValidLetter
}//end ProteinSequence
